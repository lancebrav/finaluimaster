...
try {
    ...
    $stmt = mysqli_prepare(
        $conn,
        "INSERT INTO announcements (author_user_id, title, details, location, start_date, start_time, end_date, end_time, event_type, visibility, author, photo, is_birthday)
         VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)"
    );
